...
//import static djf.settings.AppStartupConstants.PATH_LAGUAGE;
...
public class AppFileController {
    ...
    // File which saves the laguage the user chose
    static File languageFile;
    
    // There is another one in the gol.gui.LogoEditController.java
	...
	AppYesNoCancelDialogSingleton yesNoDialog = AppYesNoCancelDialogSingleton.getSingleton();
		...
		fc.setInitialDirectory(new File(PATH_WORK));
		fc.setTitle(props.getProperty(SAVE_WORK_TITLE));
		fc.getExtensionFilters().addAll(new ExtensionFilter(props.getProperty(WORK_FILE_EXT_DESC), props.getProperty(WORK_FILE_EXT)));
    ...
    /**
     * Writes/Overwrite the language Json file. Helps handleLanguageRequest.
     */
    public void writeLanguageJson() throws IOException{
        // Always overwrite the file regardless if there is one or not
        // THEN PUT IT ALL TOGETHER IN A JsonObject        
//        JsonArrayBuilder arrayBuilder = Json.createArrayBuilder();
        JsonObject languageJson = Json.createObjectBuilder()
            .add(JSON_LANGUAGE, APP_PROPERTIES_FILE_NAME).build();
//        arrayBuilder.add(languageJson);
        ...
        jsonWriter.writeObject(languageJson);
        jsonWriter.close();

        // INIT THE WRITER
        OutputStream os = new FileOutputStream(PATH_LANGUAGE);
        JsonWriter jsonFileWriter = Json.createWriter(os);
        jsonFileWriter.writeObject(languageJson);
        String prettyPrinted = sw.toString();
        PrintWriter pw = new PrintWriter(PATH_LANGUAGE);
